        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_Fields_Field_Id",
                        column: x => x.Field_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrollements", x => x.Reservation_Id);
                    table.ForeignKey(
                        name: "FK_Enrollements_Subjects_Meal_Id",
                        column: x => x.Meal_Id,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Enrollements_Users_User_Id",
                        column: x => x.User_Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollements_Meal_Id",
                table: "Enrollements",
                column: "Meal_Id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Enrollements_User_Id",
                table: "Enrollements",
                column: "User_Id");
